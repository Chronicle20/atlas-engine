...
function start() {
    ...
    goblinForest2.broadcastMessage(CWvsContext.serverNotice(6, "The ghostly air around here has become stronger. The unpleasant sound of a cat crying can be heard."));
    em.schedule("start", 3 * 60 * 60 * 1000);
}

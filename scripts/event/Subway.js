...
function takeoff() {
    //sound src: https://www.soundjay.com/transportation/metro-door-close-01.mp3const
    CField = Java.type('connection.packets.CField');
    KC_docked.broadcastMessage(CField.playSound("subway/whistle"));
    NLC_docked.broadcastMessage(CField.playSound("subway/whistle"));

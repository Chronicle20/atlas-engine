...
public enum MapleBuffStat {
    ...
    DASH2(0x40000L, true), // correct (speed)
    DASH(0x80000L, true), // correct (jump)
    MONSTER_RIDING(0x100000L, true),
    SPEED_INFUSION(0x200000L, true),
    HOMING_BEACON(0x400000L, true);

...
public class CheckDmgCommand extends Command {
   ...
   public void execute(MapleClient c, String[] params) {
      ...
      if (victim != null) {
         ...
         Integer watkBuff = victim.getBuffedValue(TemporaryStatType.WATK);
         Integer matkBuff = victim.getBuffedValue(TemporaryStatType.MATK);
         ...
         player.dropMessage(5,
               "Cur Str: " + victim.getTotalStr() + " Cur Dex: " + victim.getTotalDex() + " Cur Int: " + victim.getTotalInt()
                     + " Cur Luk: " + victim.getTotalLuk());

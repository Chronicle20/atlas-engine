...
import net.server.handlers.login.CreateSecurityHandle;
...
public final class PacketProcessor {
   ...
   public void reset(int channel) {
      ...
      if (channel < 0) {
         ...
         registerHandler(RecvOpcode.REACHED_LOGIN_SCREEN, new NoOpHandler());
         registerHandler(RecvOpcode.CREATE_SECURITY_HANDLE, new CreateSecurityHandle());
         ...
         registerHandler(RecvOpcode.ON_LOGOUT_GIFT, new LogoutGiftHandler());
      }
   }
}
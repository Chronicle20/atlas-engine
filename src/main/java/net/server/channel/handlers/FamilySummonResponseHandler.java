...
public class FamilySummonResponseHandler extends AbstractMaplePacketHandler {
   ...
   public void handlePacket(InPacket p, MapleClient c) {
      ...
      MapleInviteResult inviteResult =
            MapleInviteCoordinator.answerInvite(InviteType.FAMILY_SUMMON, c.getPlayer().getId(), c.getPlayer(), accept);
      ...
      if (accept && inviter.getMap() == map) { //cancel if inviter has changed maps
         ...
         inviter.sendPacket(CWvsContext.getFamilyInfo(inviterEntry));
